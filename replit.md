...
- `PATCH /api/spvs/:id/members/:memberId` - Update investment fields for a specific tranche (initialValue, currentValue, distributions, feesPaid, ownershipPercent, purchaseDate)
